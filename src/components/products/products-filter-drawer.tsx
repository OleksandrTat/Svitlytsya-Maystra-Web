        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 z-50 max-h-[80vh] overflow-y-auto rounded-t-3xl bg-white"
            >
              {/* Drag handle */}
              ...
              <div className="space-y-4 p-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border-b border-[var(--color-border)] bg-transparent pb-2 pl-6 text-sm outline-none placeholder:text-[var(--color-text-muted)] focus:border-[var(--color-primary)]"
                  />
                </div>
